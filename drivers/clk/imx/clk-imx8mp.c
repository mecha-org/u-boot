...
// #if CONFIG_IS_ENABLED(VIDEO)
	...
	clk_dm(IMX8MP_CLK_MEDIA_MIPI_PHY1_REF,
    imx8m_clk_composite(dev, "media_mipi_phy1_ref",
...
// #if CONFIG_IS_ENABLED(VIDEO)
	...
	clk_dm(IMX8MP_CLK_MEDIA_MIPI_PHY1_REF_ROOT,
    imx_clk_gate2_shared2(dev, "media_mipi_phy1_ref_root_clk",
                           "media_mipi_phy1_ref",
                           base + 0x45d0, 0, &share_count_media));
// #endif
